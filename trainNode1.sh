...
NCCL_DEBUG=INFO /opt/conda/bin/python -m torch.distributed.launch --nproc_per_node=4 --nnodes=3 --node_rank=1 --master_addr="192.168.2.64" --master_port=1234 train.py 2>&1 | tee insightDis.txt &